...
[ENG-0267](https://github.com/qwts/agent-sop/blob/main/docs/decisions/ENG-0267-bounded-ci-runtime.md). The owning lifecycle
...
`qwts-agent-ci`, pinned by immutable commit SHA in consumers. It:
...
- name: Install locked dependencies
  uses: qwts/qwts-agent-ci/.github/actions/bounded-command@<reviewed-sha>
  with:
...
[ENG-0269](https://github.com/qwts/agent-sop/blob/main/docs/decisions/ENG-0269-trusted-dependency-reuse.md) enclosure rule)
...
([ENG-0313](https://github.com/qwts/agent-sop/blob/main/docs/decisions/ENG-0313-ci-fan-out-backpressure.md)):
...
[dependency reuse policy](https://github.com/qwts/agent-sop/blob/main/docs/reference/dependency-reuse-policy.md); a cache hit never removes
