...
[ENG-0004](https://github.com/qwts/agent-sop/blob/main/docs/decisions/ENG-0004-centralize-shared-cicd.md), and what a consumer
...
[`governance/repos.json`](https://github.com/qwts/qwts-agent-org/blob/main/governance/repos.json) appears exactly once in
...
| `qwts-agent-sop` | None | Not applicable. The qwts instance; same disposition as the template. |
